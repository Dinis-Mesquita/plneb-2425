...
def ex9(s1,s2):    #podia ter feito so sorted e ==           ...enfim
    lista_s1=[]
    lista_s2=[]
    s1=s1.lower()
    s2=s2.lower()
    ...
    if len(lista_s1)==len(lista_s2):
        i=0
        while i <= len(lista_s1)-1:

            if lista_s1[i] not in lista_s2:
                return False
                print("false")
                break
...
def ex10(dicionario):   #dicionario{palavra a testar : palavras fixas}  ???
    lista_t=[]
    lista_f=[]
